// src/013/JS-Quickstart/about-fetch.js
// node --watch about-fetch.js
console.clear();
...
console.log('\nJust called the fetch()\n');

fetch(apiEndPoint) // Request to the web server
    .then(x => x.json()) // Parses the response as JSON
    //    x (above) is a Response object; we're expecting
    //              that Response object to contain JSON
    //    x (below) is a JavaScript object (because we)
    //              parsed it
    .then(x => {
        console.log(x);
    });
